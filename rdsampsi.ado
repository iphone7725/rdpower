...
program define rdsampsi, rclass
	...
	syntax [anything] [if] [in] [, c(real 0) tau(numlist max=1) alpha(real .05) beta(real 0.8) samph(string) NSamples(string) all ///
											 ...
											 covs(string) deriv(real 0) p(real 1) q(numlist max=1) h(string) b(string) rho(real 0) ///
											 kernel(string) bwselect(string) vce(string) ///
											 scalepar(real 1) scaleregul(real 1) fuzzy(string) level(real 90)]
